...
- Upload the audio files from "assets/audios/" to the robot. Use https://pathwi.se/tools/files.htm to upload, play or delete files from the robots. ((can also be done via the robot SDK dashboard, by using the robot IP in the browser URL, under "Explore > Expression"))
