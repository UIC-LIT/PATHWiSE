...
- Upload all the custom interaction images i.e. speaking, listening etc from the "assets/images/interactions/" to the robot using the robot default dashboard (can be accessed by using the robot IP in the browser URL)
